...
export const COLORS = {
  primary: "#aec7e8", secondary: "#ffbb78", tertiary: "#98df8a", quaternary: "#ff9896", quinary: "#c5b0d5",
  senary: "#c49c94", septenary: "#f7b6d2", octonary: "#c7c7c7", nonary: "#dbdb8d", denary: "#9edae5",
  undenary: "#CCEBC5", duodenary: "#FFED6F",
  grid:"#E5E7EA",text:"#1f2937",
  web:"#a39fc9",telephone:"#6fb899",email:"#a9b5ae",letter:"#ccb22b",other:"#bb7693",
...
export const CHANNEL_COLORS = {
  web: COLORS.web, telephone: COLORS.telephone, email: COLORS.email, letter: COLORS.letter, other: COLORS.other,
};
...
export const FLOW = {
  /** Outer page layout: spacing between sibling sections */
  page: { display: "grid", rowGap: LAYOUT.sectionMarginY },
  /** Inner section layout: spacing between header and content */
  section: { display: "grid", rowGap: LAYOUT.sectionGap },
};

export const CARD = { border:`1px solid ${COLORS.grid}`, radius:8, padding:12, bg:"#fff" };

export const BUTTON = {
  base:{ padding:"6px 10px", borderRadius:8, border:`1px solid ${COLORS.grid}`, background:"#fff", cursor:"pointer", fontWeight:600, fontSize:14 },
  activeBg:"#f1f5f9",
};

export const TOOLTIP = {
  base:{ background:"#fff", border:`1px solid ${COLORS.grid}`, borderRadius:8, padding:"8px 10px", fontSize:14, boxShadow:"0 4px 10px rgba(0,0,0,0.05)" },
...
export const SECTION = {
  container:(LAYOUT)=>({ display:"grid", gap:LAYOUT.sectionGap, marginTop:LAYOUT.sectionMarginY }),
  header:(TEXT)=>({ display:"flex", justifyContent:"space-between", alignItems:"baseline", gap:8, fontFamily:TEXT.family, color:TEXT.color }),
};
