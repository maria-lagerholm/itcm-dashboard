...
// --- Age Distribution Chart for Sweden (adapted from Norway) ---
...
export default function Sweden() {
  ...
  // --- Fetch age distribution for Sweden ---
  useEffect(() => {
    setAgeLoading(true);
  ...
  return (
    <main style={{ padding: 20, maxWidth: 1000, margin: "0 auto", fontSize: 14 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12, fontSize: 14 }}>
        <h2 style={{ fontSize: 18 }}>Sweden · Top 10 cities by {titleSuffix}</h2>
      ...
      <section style={{ marginTop: 32, marginBottom: 32, background: "#fff", borderRadius: 8, boxShadow: "0 2px 8px rgba(30,41,59,0.04)", padding: 20 }}>
        <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          <h3 style={{ margin: 0, fontSize: 16, fontWeight: 600 }}>Sweden · Age distribution by gender</h3>
          <div style={{ display: "flex", gap: 8 }}>
            <button
      ...
      <div style={{ fontSize: 14 }}>
        <MonthlySalesChart
          ...
          startYM={HIST_START}
          endYM={HIST_END}
          title="Sweden · Monthly Revenue (KSEK)"
        />
      </div>
